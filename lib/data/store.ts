...
const defaultInterventions: Intervention[] = [
  ...
  },
  {
    ...
    description: "Paired with senior architect for technical mentorship and career guidance",
    status: "in_progress",
  ...
  },
  {
    ...
    description: "Approved hybrid work schedule with 3 days remote to improve work-life balance",
    status: "completed",
    createdAt: "2024-01-10",
    completedAt: "2024-01-15",
    outcome: "Employee satisfaction improved. Overtime hours reduced by 40%.",
  },
  {
    id: "INT006",
    employeeId: "EMP022",
    type: "compensation",
    title: "Salary Review & Adjustment",
    description: "Conducted market rate analysis and proposed competitive salary adjustment",
    status: "in_progress",
  ...
  },
  {
    ...
    employeeId: "EMP028",
    type: "training",
    title: "Technical Certification Support",
    description: "Sponsored AWS Solutions Architect certification with paid study time",
    status: "planned",
  ...
  },
  {
    ...
    description: "Organized cross-functional team events to improve collaboration and morale",
    status: "completed",
    createdAt: "2024-01-08",
    completedAt: "2024-01-30",
    outcome: "Team collaboration improved. Employee reported feeling more connected to colleagues.",
  },
  {
    id: "INT009",
    employeeId: "EMP018",
    type: "career_development",
    title: "Role Expansion Discussion",
    description: "Discussed opportunity to lead new client accounts and expand responsibilities",
    status: "in_progress",
  ...
  },
  {
    ...
    employeeId: "EMP020",
    type: "workload_adjustment",
    title: "Project Rotation Program",
    description: "Assigned to new high-visibility security project to prevent burnout on legacy systems",
    status: "completed",
    createdAt: "2024-01-18",
    completedAt: "2024-02-01",
    outcome: "Employee engaged with new challenges. Risk score decreased from 62 to 48.",
  },
  {
    id: "INT011",
    employeeId: "EMP010",
    ...
    description: "Nominated for quarterly excellence award and spot bonus for Q4 performance",
    status: "completed",
    createdAt: "2024-01-05",
    completedAt: "2024-01-12",
    outcome: "Employee morale boosted. Expressed appreciation for recognition.",
  },
  {
    id: "INT012",
    employeeId: "EMP026",
    type: "training",
    title: "Advanced Analytics Upskilling",
    description: "Enrolled in machine learning and advanced analytics training program",
    status: "planned",
  ...
  },
  {
    ...
    description: "Scheduled regular 1-on-1 sessions with manager to discuss growth and concerns",
    status: "in_progress",
...
const defaultModelMetrics: ModelMetrics = {
  ...
  history: [
    { date: "2025-03-01", accuracy: 82.3, precision: 79.5, recall: 85.2, f1Score: 82.2, rocAuc: 86.5 },
    { date: "2025-06-01", accuracy: 84.1, precision: 81.0, recall: 86.8, f1Score: 83.8, rocAuc: 88.2 },
    { date: "2025-09-01", accuracy: 86.0, precision: 83.5, recall: 88.2, f1Score: 85.8, rocAuc: 89.8 },
    { date: "2025-12-15", accuracy: 87.5, precision: 84.2, recall: 89.1, f1Score: 86.6, rocAuc: 91.2 },
  ],
};
...
const defaultImports: HRISImport[] = [
  {
    id: "IMP001",
    filename: "employees_q4_2024.csv",
    importedAt: "2025-01-10",
    recordCount: 245,
    status: "success",
  ...
  {
    id: "IMP002",
    filename: "performance_reviews_2024.xlsx",
    importedAt: "2025-02-15",
    recordCount: 238,
    status: "success",
    dataCategory: "performance_review",
    categoryConfidence: 92,
  },
  {
    id: "IMP003",
    filename: "january_payroll_report.csv",
    importedAt: "2025-03-05",
    recordCount: 312,
    status: "success",
  ...
  {
    id: "IMP004",
    filename: "attendance_log_q1_2025.xlsx",
    importedAt: "2025-04-12",
    recordCount: 456,
    status: "success",
  ...
  {
    id: "IMP005",
    filename: "employee_satisfaction_survey_q1.csv",
    importedAt: "2025-05-20",
    recordCount: 189,
    status: "success",
    dataCategory: "survey",
  ...
  {
    id: "IMP006",
    filename: "new_hires_q1_2025.xlsx",
    importedAt: "2025-06-08",
    recordCount: 28,
    status: "success",
    dataCategory: "employee_data",
  ...
  {
    id: "IMP007",
    filename: "overtime_report_q1_2025.csv",
  ...
  {
    id: "IMP008",
    filename: "mid_year_bonus_distribution.xlsx",
    importedAt: "2025-08-22",
    recordCount: 203,
    status: "success",
    dataCategory: "payroll",
  ...
  {
    id: "IMP009",
    filename: "training_completion_report_h1.csv",
  ...
  {
    id: "IMP010",
    filename: "exit_interview_feedback_2025.xlsx",
    importedAt: "2025-10-18",
    recordCount: 34,
    status: "success",
    dataCategory: "survey",
  ...
  {
    id: "IMP011",
    filename: "mid_year_reviews_incomplete.csv",
  ...
  {
    id: "IMP012",
    filename: "december_payroll_draft.xlsx",
    importedAt: "2025-12-15",
    recordCount: 298,
    status: "success",
    dataCategory: "payroll",
